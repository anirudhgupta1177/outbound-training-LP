...
import { courseData, introVideoUrl } from '@/lib/data/courseData';
import {
    ...
    <CourseLayout course={courseData} completedLessons={completedLessons}>
      <div className="w-full">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 max-w-5xl">
          ...
          <div className="mb-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-amber-400 to-cyan-400 bg-clip-text text-transparent mb-4 animate-gradient">
              {courseData.title}
            </h1>
