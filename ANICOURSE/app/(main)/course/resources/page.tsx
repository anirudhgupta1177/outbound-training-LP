...
import { globalResources } from '@/lib/data/courseData';
// Using inline SVGs
...
export default function ResourcesPage() {
  ...
  const resourcesByCategory = globalResources.reduce(
    (acc, resource) => {
    ...
    {} as Record<string, typeof globalResources>
  );
                  ...
                  {resources.map((resource) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <svg className="w-4 h-4 text-gray-500 group-hover:text-cyan-400 flex-shrink-0 mt-0.5 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
