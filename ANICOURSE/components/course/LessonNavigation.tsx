...
export default function LessonNavigation({
  ...
  let prevLesson: { module: Module; lesson: Lesson } | null = null;
  ...
  // Find next lesson
  let nextLesson: { module: Module; lesson: Lesson } | null = null;
  if (
    currentModule &&
  ...
  return (
    <div className="border-t border-gray-800 pt-6 mt-8 flex items-center justify-between">
      {prevLesson ? (
        <Link
          href={`/course/${prevLesson.module.id}/${prevLesson.lesson.id}`}
