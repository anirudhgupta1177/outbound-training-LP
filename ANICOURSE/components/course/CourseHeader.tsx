...
export default function CourseHeader({
  ...
  return (
    <div className="border-b border-gray-800 bg-gradient-to-br from-[#0a0a0a] via-[#111111] to-[#0a0a0a] relative overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-r from-cyan-400/5 via-amber-400/5 to-cyan-400/5"></div>
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 relative z-10">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-cyan-400 via-amber-400 to-cyan-400 bg-clip-text text-transparent mb-4 animate-gradient">
          {title}
        </h1>
