    ...
    <div className="border border-gray-800 rounded-xl bg-[#111111] hover:border-gray-700 hover:shadow-2xl hover:shadow-cyan-400/10 transition-all group">
      <div className="p-4 sm:p-6">
        ...
        <div className="mb-4">
          ...
          <CourseProgressBar progress={progress} size="sm" showPercentage={false} />
        </div>
        ...
        {firstAvailableLesson && (
          <Link
            to={`/course/${module.id}/${firstAvailableLesson.id}`}
            className="inline-block px-5 py-2.5 bg-gradient-to-r from-cyan-400 to-emerald-500 text-white rounded-lg text-sm font-medium hover:from-cyan-300 hover:to-emerald-400 transition-all shadow-lg shadow-cyan-400/30 hover:shadow-xl hover:shadow-cyan-400/40"
          >
            {completedCount === 0
              ? 'Start Module'
              : progress === 100
