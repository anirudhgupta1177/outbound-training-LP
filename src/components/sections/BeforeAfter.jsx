...
const beforeItems = [
  {
    main: 'Spending 4 hours finding leads on LinkedIn',
    sub: 'Then realizing half are wrong contacts',
  },
  {
    main: 'Copy-pasting the same generic template 100 times',
...
const afterItems = [
  {
    main: 'AI scrapes 1000+ verified leads in 10 minutes',
    sub: 'From multiple sources, auto-enriched with intent signals',
  },
  {
    main: 'AI writes personalized emails for each prospect',
    sub: 'Based on their website, LinkedIn, recent activity',
  },
  {
    main: 'System auto-sends 1000+ emails daily across multiple inboxes',
  ...
  return (
    <section className="py-12 md:py-20 relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          title="Still Wasting 20+ Hours a Week Manually Prospecting... And Getting Ghosted?"
        />
